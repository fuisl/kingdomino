...
public abstract class AbstractPlayerIconRenderManager {
    protected GameManager gameManager;
    protected PlayerIconActor[] playerIconActors;
    protected int kingCount;
    protected Skin skin;

    public AbstractPlayerIconRenderManager(GameManager gameManager, TextureRegion[] kingAvatar, Skin skin) {
